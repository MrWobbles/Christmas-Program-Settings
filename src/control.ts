    ...
    lines: [
      {
        speaker: 'Angel (Narrator)',
        text:
          'The long انتظار (en-tuh-ZAR, meaning waiting / expectation) was over. In the stillness of Bethlehem, God\'s promise was about to be seen with human eyes.',
      },
      {
        speaker: 'Angel (Narrator)',
        text:
          'There was no room in any inn, so the Savior of the world was born in a stable and laid in a manger.',
      },
      {
        speaker: 'Angel (Narrator)',
        text:
          'Luke 2:6-7 (NKJV)<br/>So it was, that while they were there, the days were completed for her to be delivered. And she brought forth her firstborn Son, and wrapped Him in swaddling cloths, and laid Him in a manger, because there was no room for them in the inn.',
      },
      {
        speaker: 'Angel (Narrator)',
        text:
          'On that holy night, heaven touched earth. The Prince of Peace had come, and God was with us.',
      },
    ],
